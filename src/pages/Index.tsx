        ...
        <div className="container mx-auto max-w-6xl">
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <Link to="/blog" className="group">
              <div className="p-8 bg-card rounded-xl shadow-soft hover:shadow-medium transition-all duration-300 border border-border">
                <h3 className="text-2xl font-serif font-bold mb-3 group-hover:text-accent transition-colors">Blog</h3>
                <p className="text-foreground/70">Notes on cloud infrastructure and engineering</p>
              </div>
            </Link>
          </div>
        </div>
